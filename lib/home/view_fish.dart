...
class ScheduledActivitiesPage extends StatefulWidget {
  const ScheduledActivitiesPage({super.key});
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            children: [
                              buildInputField("Gold Fish"), // Fish Type
                              const SizedBox(height: 16),
                              buildInputField("45 cm"), // Size
                              const SizedBox(height: 16),
                              buildInputField("Sugar cane"), // Food Type
                              const SizedBox(height: 16),
                              buildInputField("25°C"), // Water Temperature
                            ],
                          ),
                        ),
                      ],
